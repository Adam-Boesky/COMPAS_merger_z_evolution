...
num_systems = 10000                  # Number of binary systems to evolve                                              # Note: overrides runSubmit + compasConfigDefault.yaml value
output_folder = 'output2/'           # Location of output folder (relative to cwd)                                     # Note: overrides runSubmit + compasConfigDefault.yaml value
random_seed_base = 0                # The initial random seed to increment from                                       # Note: overrides runSubmit + compasConfigDefault.yaml value

num_cores = 1                       # Number of cores to parallelize over 
num_per_core = 10000                  # Number of binaries per batch
